...
public:
     ...
     * :input stage:        which stage to start from
     ...
     */
    void Resume(int stage, FILE* fd);
    /**
     * Write parameters to a binary file
     * :input fd:           file discriptor of the model file
     * :input stage:        stage
     *
     * Write the model parameters from stage 1 to stage `stage`,
     * the default stage is the last one.
     */
    void SerializeTo(FILE* fd, int stage = 0);
    /**
     * Read parameters from a binary file
     * :input fd:           file discriptor of the model file
     * :input stage:        stage
     *
     * Read model parameters from stage 1 to stage `stage`,
     * the default stage is the last one.
     */
    void SerializeFrom(FILE* fd, int stage = 0);
